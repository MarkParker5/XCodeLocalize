...
def getBasePath(name = 'Localizable'):
	return f'../PeFi/Localization/Base.lproj/Localizable.strings'

def getFilePath(name = 'Localizable', lang):
	return f'../PeFi/Localization/{lang}.lproj/Localizable.strings'
...
for name in ['Localizable', 'InfoPlist']:
    ...
    for lang in languages:
        print(f"\nLang: <{lang}>:")
        langDict = getFileAsDict(file = getFilePath(name, lang))	# old strings from file
        ...
        addStringsDictToFile(dict = langNewDict, file = getFilePath(name, lang))
